...
What would happen if every time you walked up to an intersection you just turned in a random direction? Here's one run of the simulation. Like real people, the random walk gets pretty lost in the dense streets of lower Manhattan. If you're interested in generating one of these for yourself or just seeing the code, feel free to follow along with the [jupyter notebook](https://github.com/sunnybala/sunnybala.github.io/blob/master/assets/notebooks/manhattan_random_walk.ipynb) via my GitHub.
